...
abstract class BrandTemplate with _$BrandTemplate {
  const factory BrandTemplate({
    ...
    @Default(true) bool standbyFullscreen,
    @Default(true) bool standbyShowText,
    @Default(0xFFFFFFFF) int standbyTextColor,
    @Default('bottomLeft') String standbyTextPosition,
    @Default(0xFF000000) int standbyBackgroundColor,
