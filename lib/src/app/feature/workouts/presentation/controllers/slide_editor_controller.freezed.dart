...
mixin _$SlideEditorState {
 ...
 WorkoutModule get module; WorkoutModule get saved; List<WorkoutModule> get styles; WorkoutModule? get recovery; bool get localSaved; String? get storageError;
...
int get hashCode {
  final _this = this as SlideEditorState;
  return Object.hash(runtimeType,_this.module,_this.saved,const DeepCollectionEquality().hash(_this.styles),_this.recovery,_this.localSaved,_this.storageError);
}

@override
String toString() {
  final _this = this as SlideEditorState;
  return 'SlideEditorState(module: ${_this.module}, saved: ${_this.saved}, styles: ${_this.styles}, recovery: ${_this.recovery}, localSaved: ${_this.localSaved}, storageError: ${_this.storageError})';
}
...
@useResult
$Res call({
 WorkoutModule module, WorkoutModule saved, List<WorkoutModule> styles, WorkoutModule? recovery, bool localSaved, String? storageError
});
...
/// Create a copy of SlideEditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? module = null,Object? saved = null,Object? styles = null,Object? recovery = freezed,Object? localSaved = null,Object? storageError = freezed,}) {
...
as WorkoutModule,styles: null == styles ? _self.styles : styles // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WorkoutModule module,  WorkoutModule saved,  List<WorkoutModule> styles,  WorkoutModule? recovery,  bool localSaved,  String? storageError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SlideEditorState() when $default != null:
return $default(_that.module,_that.saved,_that.styles,_that.recovery,_that.localSaved,_that.storageError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WorkoutModule module,  WorkoutModule saved,  List<WorkoutModule> styles,  WorkoutModule? recovery,  bool localSaved,  String? storageError)  $default,) {final _that = this;
switch (_that) {
case _SlideEditorState():
return $default(_that.module,_that.saved,_that.styles,_that.recovery,_that.localSaved,_that.storageError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WorkoutModule module,  WorkoutModule saved,  List<WorkoutModule> styles,  WorkoutModule? recovery,  bool localSaved,  String? storageError)?  $default,) {final _that = this;
switch (_that) {
case _SlideEditorState() when $default != null:
return $default(_that.module,_that.saved,_that.styles,_that.recovery,_that.localSaved,_that.storageError);case _:
  return null;
...
class _SlideEditorState extends SlideEditorState {
  const _SlideEditorState({required this.module, required this.saved,  List<WorkoutModule> styles = const [], this.recovery, this.localSaved = false, this.storageError}): _styles = styles,super._();
...
/// Create a copy of SlideEditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? module = null,Object? saved = null,Object? styles = null,Object? recovery = freezed,Object? localSaved = null,Object? storageError = freezed,}) {
  return _then(_SlideEditorState(
module: null == module ? _self.module : module // ignore: cast_nullable_to_non_nullable
as WorkoutModule,saved: null == saved ? _self.saved : saved // ignore: cast_nullable_to_non_nullable
as WorkoutModule,styles: null == styles ? _self._styles : styles // ignore: cast_nullable_to_non_nullable
as List<WorkoutModule>,recovery: freezed == recovery ? _self.recovery : recovery // ignore: cast_nullable_to_non_nullable
as WorkoutModule?,localSaved: null == localSaved ? _self.localSaved : localSaved // ignore: cast_nullable_to_non_nullable
as bool,storageError: freezed == storageError ? _self.storageError : storageError // ignore: cast_nullable_to_non_nullable
as String?,
